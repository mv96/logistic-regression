...
accuracy(1)=classification_model(part_1x,part_1y,remaining_data_x1,remaining_data_y1);

%train part2 and test on all other parts
accuracy(2)=classification_model(part_2x,part_2y,remaining_data_x2,remaining_data_y2);

%train part3 and test on all other parts
accuracy(3)=classification_model(part_3x,part_3y,remaining_data_x3,remaining_data_y3); 

%train part4 and test on all other parts
accuracy(4)=classification_model(part_4x,part_4y,remaining_data_x4,remaining_data_y4);

%train part5 and test on all other parts
accuracy(5)=classification_model(part_5x,part_5y,remaining_data_x5,remaining_data_y5);
